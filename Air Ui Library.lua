...
function Library:Create(hubname, gamename, presetColor)
	...
	function Win:Page(pagename, mainpage)
		...
		Page.Parent = Pages
		Page.Active = true
		Page.BackgroundColor3 = Color3.fromRGB(200, 100, 10)
		...
		function PageItems:Button(buttonname, callback)
			...
			Button.Name = "Button"
			Button.Parent = Page
			Button.BackgroundColor3 = Color3.fromRGB(5, 10, 20)
		...
		function PageItems:Toggle(togglename, callback)
			...
			Toggle.Name = "Toggle"
			Toggle.Parent = Page
			Toggle.BackgroundColor3 = Color3.fromRGB(40, 80, 160)
		...
		function PageItems:Slider(slidername, minvalue, maxvalue, callback)
			...
			Slider.Name = "Slider"
			Slider.Parent = Page
			Slider.BackgroundColor3 = Color3.fromRGB(212, 212, 160)
		...
		function PageItems:Dropdown(dropdownname, itemlist, callback)
			...
			Dropdown.BackgroundColor3 = Color3.fromRGB(80, 40, 20)
