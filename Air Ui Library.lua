...
local Utility = {}
local Objects = {}
function Air:DraggingEnabled(frame, parent)
...
function Air.CreateLib(airName, themeList)
    ...
    local selectedTab 
    airName = airName or "Library"
    table.insert(Air, airName)
    for i,v in pairs(game.CoreGui:GetChildren()) do
        if v:IsA("ScreenGui") and v.Name == airName then
            v:Destroy()
        end
    end
    ...
    Air:DraggingEnabled(MainHeader, Main)
    ...
    function Air:ChangeColor(prope,color)
