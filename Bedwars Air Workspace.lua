...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/vqfx/SytroNight4ROBLOX/main/libraries/kavo.lua", true))() 
local Window = Library.CreateLib("Bedwars AirForce-X V4", "BloodTheme")

local colorbox 
 local function makeRainbowText(text) 
         spawn(function() 
                 colorbox = Color3.fromRGB(255,0,0) 
                 local x = 0 
                 while wait() do 
